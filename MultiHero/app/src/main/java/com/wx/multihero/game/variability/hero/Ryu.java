...
public class Ryu extends Hero {
    ...
    public void load(Character character) {
        ...
        action.setBreakable(true);
        action = getAction(Action.ID.JUMP2);//二段跳
        ...
        action.add(10, bmpSet.get(0)).setSound(assetsLoader.loadSound("ryuBall"));//添加音乐
        action.add(10, bmpSet.get(1));
        action.add(10, bmpSet.get(2)).setChunk(Chunk.Type.RYU_BLUE_BALL_IMPACT, 30, -32);//攻击波
