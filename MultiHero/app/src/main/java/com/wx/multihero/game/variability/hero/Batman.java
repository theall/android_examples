...
public class Batman extends Hero {
    ...
    public Batman(Character character) {
        super(character);
    }
    public void load(Character character) {
        ...
        action.add(10, bmpSet.get(1)).setChunk(Chunk.Type.DRAGON_BALL_DOUBLE, 30, -32);
        action.add(10, bmpSet.get(2));
        //action.add(10, bmpSet.get(3));
        //action.add(10, bmpSet.get(4));
        ...
        //frame.setVector(4f, -4f);
        //frame.setSound(assetsLoader.loadSound("ryuSpin"));
        action.add(15, bmpSet.get(0));
        action.add(15, bmpSet.get(1)).setVector(2f, -4f);
        //       重复播放 action.setTimes(1);
        ...
        //      action.add(5, bmpSet.get(0)).setChunk(Chunk.Type.RYU_BLUE_BALL_IMPACT, 10, -12);
